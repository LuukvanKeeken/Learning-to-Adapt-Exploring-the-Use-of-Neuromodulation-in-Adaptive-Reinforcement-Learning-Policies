...
parser.add_argument('--max_grad_norm', type=float, default=10, help='Maximum norm for the gradients')
parser.add_argument('--tau_sys_extraction', type=bool, default=True, help='Whether to extract the tau system from the CfC network')
parser.add_argument('--sparsity_level', type=float, default=0.5, help='Sparsity level for the AutoNCP wiring')
parser.add_argument('--wiring', type=Wiring, default=None, help='Whether to use the AutoNCP wiring')
